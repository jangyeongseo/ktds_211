...
-- 114. (22건) 가장 늦게 입사한 사원의 입사일 보다 1년  입사한 사원의 모든 정보를 조회한다.
SELECT
	EMPLOYEE_ID,
	FIRST_NAME,
	LAST_NAME,
...
SELECT
	...
	SALARY,
	COMMISSION_PCT,
	SALARY + (SALARY * NVL(COMMISSION_PCT, 0)) AS TOTAL_YEAR_SALARY
FROM
	EMPLOYEES
;
