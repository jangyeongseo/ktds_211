...
public interface FilesDao {
	...
	List<String> selectFilePathByFileGroupIdAndFileNums(SaerchFileGroupVO saerchFileGroupVO);

	int deleteFilesByFileGroupIdAndFileNums(SaerchFileGroupVO saerchFileGroupVO);
